...
module.exports = {
  ...
  OWNER_NUMBER: settings.OWNER_NUMBER || process.env.OWNER_NUMBER || "256707770808",
  OWNER_NAME: process.env.OWNER_NAME || getConfig("jsmoke") || "jsmoke 256",
  DEV: process.env.DEV || "256707770808",
